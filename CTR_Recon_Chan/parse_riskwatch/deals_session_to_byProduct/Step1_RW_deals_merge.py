...
if session == 'var':
    ...
    parent_folder = 'C:/Users/cnamgoong/Desktop/Shared/RW/VAR Session/market.16.08.15/'
    ...
    #in folder + out folder
    parent_folder = 'C:/Users/cnamgoong/Desktop/Shared/RW/Algo Session/2016.08.10/'
    in_folder = parent_folder + 'k2 folder'
    out_folder = parent_folder + 'all/'
    out_file = 'deals.csv'
    out_audit_file = 'deals_audit.csv'
