...
in_CTR_file = 'out_MXNOPICS/' + 'out_MXNOPICS_FXOption_CTR_preprocessed_file.csv'
in_VAR_folder = 'C:/Users/cnamgoong/Desktop/Shared/RW/CTR Files/2016-08-10-PROD/'
in_VAR_file = 'out_MXNOPICS/' + 'out_MXNOPICS_FXOption_VAR_preprocessed_file.csv'
...
#out files
out_file_diff = 'out_MXNOPICS/' + 'out_MXNOPICS_FXOption_diff.csv'
out_file_inVAR_notCTR = 'out_MXNOPICS/' + 'out_MXNOPICS_FXOption_inVAR_notCTR.csv'
out_file_inCTR_notVAR = 'out_MXNOPICS/' + 'out_MXNOPICS_FXOption_inCTR_notVAR.csv'
out_file_columns_diff = 'out_MXNOPICS/' + 'out_MXNOPICS_FXOption_diff_columns_diff.csv'
